// This imports sounds from the server.  These are the only sounds that
// are not synthesized.  We load  the sounds at runtime, and then
// save them in an object called drumSounds To understand this code more,
// please reference my blog post:
...
var routes = ['kick.wav', 'hh.wav', 'synride.wav', 'syncowbell.wav',
  'synfx.wav', 'synshaker.wav'];
